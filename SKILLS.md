...
| `cs-seo-website` | seo | draft | 0.1 | CodeSpring marketing-site SEO: robots/sitemaps/canonicals, Search Console exports, docs/tutorials, the Vibe Code Library, listings and referral links. Operates on the CodeSpring website repo, not customer projects. |
