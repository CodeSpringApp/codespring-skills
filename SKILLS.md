...
| `cs-marketing-image-ads` | marketing | draft | 0.1 | Create and revise static paid-social image ads from approved offers, customer pain and visual references. Owns reviewed creative files, copy/prompt manifest and campaign handoff; covers identity, anatomy, UI credibility, mobile review and scoped revisions. Derived from CodeSpring ad iterations; packaged workflow awaits a fresh campaign run. |
